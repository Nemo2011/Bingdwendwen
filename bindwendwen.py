"""
This is a program that drawing Bing Dwendwen using python turtle graphics. GUI based on Python Tkinter(TCL/TK) see the turtle library.
Copied YiMo Xia, 2022-2-8. Source Link:https://mp.weixin.qq.com/s/maA0rRW4dNHtXbm2vwTVOA
"""
